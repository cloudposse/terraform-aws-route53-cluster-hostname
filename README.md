...
File a GitHub [issue](https://github.com/cloudposse/terraform-aws-route53-cluster-hostname/issues), send us an [email](mailto:hello@cloudposse.com) or reach out to us on [Gitter](https://gitter.im/cloudposse/).
...
If you are interested in being a contributor and want to get involved in developing `terraform-aws-route53-cluster-hostname`, we would love to hear from you! Shoot us an [email](mailto:hello@cloudposse.com).
